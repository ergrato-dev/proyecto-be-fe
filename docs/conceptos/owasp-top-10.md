...
> La documentación estática de la API está disponible en [`docs/referencia-tecnica/api-endpoints.md`](../referencia-tecnica/api-endpoints.md) como alternativa segura a Swagger UI en producción.
