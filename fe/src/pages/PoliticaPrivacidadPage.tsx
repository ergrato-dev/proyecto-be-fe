  ...
  return (
    ...
    >
      ...
      <p className="text-sm leading-relaxed text-gray-400">
        En cumplimiento de la <strong className="text-gray-300">Ley 1581 de 2012</strong> —Régimen
        General de Protección de Datos Personales— y el{" "}
        <strong className="text-gray-300">Decreto 1377 de 2013</strong> reglamentario, la empresa{" "}
        ...
        <strong className="text-gray-300">NN Auth System</strong>.
      </p>
      <p className="text-sm leading-relaxed text-gray-400">
        ...
        <strong className="text-gray-300">Superintendencia de Industria y Comercio (SIC)</strong>{" "}
      ...
      <LegalSection id="responsable" number="1" heading="Responsable del Tratamiento">
        ...
        <address className="not-italic">
          <ul className="mt-2 space-y-1">
            <li>
              <strong className="text-gray-300">Razón social:</strong> {RESPONSABLE.nombre}
            </li>
            <li>
              <strong className="text-gray-300">NIT:</strong> {RESPONSABLE.nit}
            </li>
            <li>
              <strong className="text-gray-300">Domicilio:</strong> {RESPONSABLE.domicilio}
            </li>
            <li>
              <strong className="text-gray-300">Canal de atención — datos personales:</strong>{" "}
              <a
            ...
            <li>
              <strong className="text-gray-300">Teléfono:</strong> {RESPONSABLE.telefono}
            </li>
          </ul>
        </address>
      </LegalSection>
      ...
      <LegalSection id="datos-recolectados" number="2" heading="Datos Personales Recolectados">
        <p>
          ...
          <strong className="text-gray-300">finalidad</strong> (Art. 4.b, Ley 1581/2012) y el
          principio de <strong className="text-gray-300">necesidad</strong> (Art. 4.d, Ley
          1581/2012):
        </p>
        <ul className="ml-4 mt-2 list-disc space-y-2">
          <li>
            <strong className="text-gray-300">Nombre completo</strong> — nombre y apellido del
            usuario registrado.
          </li>
          <li>
            <strong className="text-gray-300">Dirección de correo electrónico</strong> — utilizada
            como identificador único y canal de comunicación (verificación de cuenta, recuperación
            de contraseña).
          </li>
          <li>
            <strong className="text-gray-300">Contraseña hasheada</strong> — almacenada únicamente
            como hash bcrypt; nunca en texto plano. El Responsable no puede recuperar ni ver la
            contraseña original.
          </li>
          <li>
            <strong className="text-gray-300">Dirección IP y datos de sesión</strong> — registrados
            automáticamente en los logs del servidor por razones técnicas y de seguridad, conforme
            al Decreto 1078 de 2015.
          </li>
          <li>
            <strong className="text-gray-300">Fecha y hora de registro</strong> — metadato técnico
            generado automáticamente en la creación de la cuenta.
          </li>
        </ul>
        <p>
          <strong className="text-gray-300">No se recolectan</strong> datos sensibles (Art. 5, Ley
      ...
      <LegalSection id="finalidad" number="3" heading="Finalidad del Tratamiento">
        <p>
          ...
          <strong className="text-gray-300">artículo 13 del Decreto 1377 de 2013</strong>:
        </p>
        <ul className="ml-4 mt-2 list-disc space-y-2">
          <li>
            <strong className="text-gray-300">Autenticación y seguridad:</strong> verificar la
            identidad del usuario y gestionar el acceso al Servicio mediante tokens JWT.
          </li>
          <li>
            <strong className="text-gray-300">Comunicaciones del servicio:</strong> enviar correos
            de verificación de cuenta y recuperación de contraseña.
          </li>
          <li>
            <strong className="text-gray-300">Mantenimiento de la cuenta:</strong> permitir al
            usuario actualizar su perfil y gestionar su contraseña.
          </li>
          <li>
            <strong className="text-gray-300">Seguridad y auditoría:</strong> detectar y prevenir
            accesos no autorizados, fraudes o abusos del Servicio.
          </li>
          <li>
            <strong className="text-gray-300">Propósito educativo:</strong> demostración de buenas
            prácticas de autenticación en el contexto del Proyecto SENA.
          </li>
        </ul>
        <p>
          Los datos <strong className="text-gray-300">no serán usados</strong> para perfilamiento
      ...
      <LegalSection id="autorizacion" number="4" heading="Autorización del Titular">
        <p>
          ...
          <strong className="text-gray-300">artículo 9 de la Ley 1581 de 2012</strong> y el{" "}
          <strong className="text-gray-300">artículo 7 del Decreto 1377 de 2013</strong>, el
        ...
        <p>
          ...
          <strong className="text-gray-300">Ley 527 de 1999</strong>.
        </p>
        <p>
      ...
      <LegalSection id="derechos" number="5" heading="Derechos del Titular (Art. 8, Ley 1581/2012)">
        ...
        <ul className="ml-4 mt-2 list-disc space-y-2">
          <li>
            <strong className="text-gray-300">Conocer</strong> los datos personales que obran en las
            bases de datos del Responsable y la información relativa a su tratamiento.
          </li>
          <li>
            <strong className="text-gray-300">Actualizar y rectificar</strong> sus datos cuando sean
            inexactos, incompletos o desactualizados.
          </li>
          <li>
            <strong className="text-gray-300">Suprimir (derecho al olvido)</strong> sus datos cuando
          ...
          <li>
            <strong className="text-gray-300">Revocar la autorización</strong> para el tratamiento
            de sus datos, en los términos del artículo 9 de la Ley 1581/2012.
          </li>
          <li>
            <strong className="text-gray-300">Acceder gratuitamente</strong> a sus datos personales
          ...
          <li>
            <strong className="text-gray-300">Presentar quejas</strong> ante la SIC por infracción a
        ...
        <p>
          ...
          <strong className="text-gray-300">10 días hábiles</strong> (consultas, Art. 14 Ley
          1581/2012) o <strong className="text-gray-300">15 días hábiles</strong> (reclamos, Art. 15
      ...
      <LegalSection id="conservacion" number="6" heading="Tiempo de Conservación de los Datos">
        <p>
          ...
          por un período adicional de <strong className="text-gray-300">5 años</strong> a partir de
      ...
      <LegalSection id="transferencias" number="7" heading="Transferencias y Transmisiones">
        <p>
          ...
          <strong className="text-gray-300">no son transferidos ni transmitidos</strong> a terceros
          con fines comerciales. Podrán compartirse únicamente en los siguientes casos, conforme al{" "}
          <strong className="text-gray-300">artículo 26 de la Ley 1581/2012</strong>:
        </p>
        <ul className="ml-4 mt-2 list-disc space-y-2">
          <li>
            <strong className="text-gray-300">Encargados del tratamiento</strong> (proveedores de
            infraestructura técnica), quienes quedan vinculados por contrato al cumplimiento de la
            Ley 1581/2012.
          </li>
          <li>
            <strong className="text-gray-300">Autoridades competentes</strong> (judiciales,
            fiscales, administrativas) cuando medie orden legal o requerimiento oficial.
          </li>
          <li>
            <strong className="text-gray-300">Terceros con autorización expresa</strong> del
      ...
      <LegalSection id="seguridad" number="8" heading="Medidas de Seguridad">
        <p>
          ...
          cumplimiento del principio de <strong className="text-gray-300">seguridad</strong> (Art.
          4.g, Ley 1581/2012):
        </p>
        <ul className="ml-4 mt-2 list-disc space-y-2">
          <li>
            Hashing de contraseñas con <strong className="text-gray-300">bcrypt</strong> — las
            contraseñas nunca se almacenan en texto plano.
          </li>
          <li>
            Comunicaciones cifradas con <strong className="text-gray-300">HTTPS/TLS</strong>.
          </li>
          <li>
      ...
      <LegalSection id="rnbd" number="9" heading="Registro Nacional de Bases de Datos (RNBD)">
        <p>
          Conforme al <strong className="text-gray-300">Decreto 886 de 2014</strong> y el{" "}
          <strong className="text-gray-300">Decreto 090 de 2018</strong>, las bases de datos que
      ...
      <LegalSection id="autoridad" number="10" heading="Autoridad de Control">
        ...
        <address className="not-italic mt-2 space-y-1">
          <p>
            <strong className="text-gray-300">Portal web:</strong>{" "}
            <a
              href="https://www.sic.gov.co"
              target="_blank"
              rel="noopener noreferrer"
          ...
          <p>
            <strong className="text-gray-300">Línea gratuita:</strong> 01 8000 910 165
          </p>
          <p>
            <strong className="text-gray-300">Dirección:</strong> Carrera 13 N° 27-00, Bogotá D.C.
          </p>
        </address>
      </LegalSection>
      ...
      <LegalSection id="vigencia" number="11" heading="Vigencia y Modificaciones">
        <p>
          ...
          <strong className="text-gray-300">1 de febrero de 2026</strong>. El Responsable se reserva
        ...
        <p>
          ...
          <strong className="text-gray-300">10 días hábiles de antelación</strong>. El uso
